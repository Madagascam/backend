...
def get_first_move_timestamp(pgn_file: str) -> int:
...
def calculate_offset_in_video(video_filename: str, pgn_file: str) -> float:
...
def extract_move_timestamps(pgn_file: str, start_move: int, end_move: int, first_move_time: float) -> List[Tuple[float, float]]:
...
def cut_video_ffmpeg(video_path: str, timestamps: List[Tuple[float, float]], output_path: str) -> None:
